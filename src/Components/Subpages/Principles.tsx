  ...
  return (
    <div className={classes.container}>
        <div className={classes.heroContentContainer}>
          ...
          <br/>
          <Typography variant="h3" className={clsx(classes.bold, classes.reduceLeading)}>
            Get quicker at recognizing the problems.
          </Typography>
          <Typography variant="h3" className={clsx(classes.bold, classes.reduceLeading)}>
            Broadly compare strengths and weaknesses of different approaches.
          </Typography>
          <Typography variant="h3" className={clsx(classes.bold, classes.reduceLeading)}>
            Expand known possibilities.
          </Typography>
        </div>
    </div>
  )
